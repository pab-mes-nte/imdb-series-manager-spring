...
public class SeriesRandomizer {
    ...
    public void randomize() {
        ...
        for (String s : data.series) {
            Series serie = new Series(s, data.contentRatings[r.nextInt(data.contentRatings.length)], LocalDate.of(r.nextInt(124) + 1900, r.nextInt(12) + 1, r.nextInt(28) + 1), "I'm not going to randomize a plot. Generated by M.", "Same for the awards, I'm too lazy.", null, r.nextInt(100) + 1, r.nextInt(100) + 1, r.nextInt(1000000), r.nextInt(10) + 1);
